...
public class DbConnection {
    ...
    static {
        try {
            ...
            System.out.println("[DbConnection] Initialized HikariCP pool successfully.");

        } catch (Exception e) {
            System.err.println("[DbConnection] Warning: HikariCP pool failed to initialize. Error: " + e.getMessage());
            dataSource = null;
        }
    }
    ...
    public static Connection getConnection() throws SQLException {
        if (dataSource == null) {
            throw new SQLException("HikariCP connection pool is not available.");
        }
